...
### Next steps
- IO Board SKiDL netlist (Stage 2) — FE1.1s pin mapping needs verification against KiCad symbol
- IO Board gen_pcb.py (Stage 3–4) — 50×80mm, panel-mount components along left edge
- IO Board routing via FreeRouting (Stage 5–7)
